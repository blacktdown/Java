...
public class StringMemberTest {
	public static void main(String[] args) {
		...
		//subString - 문자열 자르기
		System.out.println("문자열 str에서 0에서 5까지의 문자열: "+str.substring(0, 5));
		System.out.println("문자열 str에서 6에서 마지까지의 문자열: "+str.substring(6));
		
		//indexOf, lastIndexOf - 문자열에서 특정문자 인덱스 번호 추출
